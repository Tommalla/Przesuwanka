...
const QString HELP_MESSAGE = QString::fromUtf8((QString("<center> Ktoś był na tyle \"sprytny\", żeby wymyślić *genialną* nazwę \"przesuwanka\" na") +
	...
	QString("<h4>Tryb gry:</h4><br/>") +
	QString("<b>LPM/PPM na klocek</b> - ruch/cofnięcie ruchu<br/>") +
	QString("<b>Strzałki</b> - możliwy ruch w danym kierunku<br/>") +
	QString("<b>Backspace</b> - cofnięcie ruchu<br/>") + 
	SOLUTION_MSG.toUtf8()).toStdString().c_str());
